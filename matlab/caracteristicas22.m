...
for p = 1:N_PACIENTES
    ...
    [p_theta, p_alpha, p_beta, p_total] = calcularPotencias2(N_ELECTRODOS, N_TRIALS_M, s_eeg_theta, s_eeg_alpha, s_eeg_beta, s_eeg_gamma);
...
c_valence = zeros(N_PACIENTES*N_TRIALS_M, 10);
...
c_arousal = zeros(N_PACIENTES*N_TRIALS_M, 17);
